...
if (isset($_POST['save_info'])) {
	...
	if ($File_name != NULL && $File_name2 != NULL) {
		...
		$getdata->my_sql_update($connect, "system_info", "site_title='" . addslashes($_POST['site_title']) . "',site_footer='" . addslashes($_POST['site_footer']) . "'", NULL);
	}

	// $getdata->my_sql_update($connect, "system_info", "site_key='" . addslashes($_POST['token_notify']) . "'", NULL);
