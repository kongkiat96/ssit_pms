...
<div class="row">
    <div class="col-12">
        <h1 class="page-header"><i class="fa fa-sliders-h fa-fw"></i> ตั้งค่าห้องพัก</h1>
    </div>
</div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title font-weight-bold">เพิ่มชั้น</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="service_name">ชื่อชั้น</label>
                    ...
                    <div class="form-group">
                        <label for="service_group">อาคาร</label>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <div class="col-12">
                            <label for="se_group">อาคาร</label>
                            <select name="se_group" class="form-control select2bs4" id="se_group" onchange="getroomList(this.value)" required>
                                <option value="">--- เลือกข้อมูล ---</option>
                                <option value="1">อาคาร Vertex View </option>
                                <option value="2">อาคาร Horizon </option>
                                <option value="3">อาคาร Vertical View </option>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label for="se_id">ชั้น</label>
                            <select class="form-control select2bs4" name="se_id" id="se_id" required>
                    ...
                    <div class="form-group">
                        <div class="col-12">
                            <label for="service_list_name">ชื่อห้อง/รหัสห้อง</label>
    ...
    <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
            <li class="nav-item font-weight-bold">
                <a class="nav-link text-success active" id="service-tab" data-toggle="tab" href="#service" role="tab" aria-controls="service" aria-selected="true">หมวดหมู่อาคารและห้องพัก</a>
            </li>
        </ul>
    </div>
    <div class="card-body">
        <div class="tab-content" id="myTabContent">
            ...
            <div class="tab-panel fade show active" id="service" role="tabpanel" aria-labelledby="service-tab">
                <div class="card shadow">
                    <div class="card-body">
                        <button class="btn btn-success btn-xs float-right btn-outline mb-2 ml-2" data-toggle="modal" data-target="#modal_new_service_list"><i class="fa fa-tasks fa-fw"></i> เพิ่มห้อง</button>
                        <button class="btn btn-success btn-xs float-right btn-outline mb-2" data-toggle="modal" data-target="#modal_new_service"><i class="fa fa-list-ul fa-fw"></i> เพิ่มชั้น</button>
