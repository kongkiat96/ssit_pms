...
<div class="modal-body">
    <div class="form-group">
        <div class="col-12">
            <label for="se_group_edit">อาคาร</label>
            <select name="se_group_edit" class="form-control select2bs42" id="se_group_edit" onchange="getroomList_edit(this.value)" required>
    ...
    <div class="form-group">
        <div class="col-12">
            <label for="se_id_edit">ชั้น</label>
            <select class="form-control select2bs42" name="se_id_edit" id="se_id_edit" required>
